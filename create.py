...
def check_wd_open():
    ...
    print("BBBBBB hour_rounded = ", hour_rounded, type(hour_rounded), "open start time = ",datetime.strptime(open_start_time[dt_p_week_day],%H),type(datetime.strptime(open_start_time[dt_p_week_day])))
